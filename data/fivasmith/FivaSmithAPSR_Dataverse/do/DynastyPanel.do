use  ~/github/pr-gendergap/data/fivasmith/FivaSmithAPSR_Dataverse/dta/DataPrep, clear

gen initial = regexs(1) if regexm(firstname,"(^[A-ZÅÆØ])" )
sort seat year party lastname firstname
// merge seat year party lastname firstname using  ~/github/pr-gendergap/data/fivasmith/FivaSmithAPSR_Dataverse/dta/ImportNorwayMPs
...
save  ~/github/pr-gendergap/data/fivasmith/FivaSmithAPSR_Dataverse/dta/DynastyPanel_Early.dta, replace  /* for making trends in mpprecede from 1945 onwards */
...
// merge lastname using  ~/github/pr-gendergap/data/fivasmith/FivaSmithAPSR_Dataverse/dta/LastNamesNorway.dta
...
save  ~/github/pr-gendergap/data/fivasmith/FivaSmithAPSR_Dataverse/dta/DynastyPanel.dta, replace
