...
tex_out <- modelsummary(results_tidy,
  coef_map = clist,
  gof_omit = ".*",
  caption = "\\label{tab:norway_main_tri} \\textbf{Heterogeneity-in-DiscontinuityEstimates For Incumbency Advantage In Norwegian Municipalities, with triangular kernels.} Women Face Diminished Incumbency Effect On Winning Again.",
  booktabs = TRUE,
  add_rows = row_mat,
  kable_format = "latex",
  output = "latex"
...
cat(tex_out, file = "output/tables/norway_main_tri.tex")
